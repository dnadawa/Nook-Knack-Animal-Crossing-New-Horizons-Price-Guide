...
class _FossilsState extends State<Fossils> {
  ...
  onCaughtPress() {
    if (newCaught.contains(email)) {
      ...
      collectionReference.document(infoName).updateData({'caught': newCaught});
    } else {
      newCaught.add(email);
      setState(() {
        isCaught = true;
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          image: DecorationImage(
              image: AssetImage('images/fossilback.png'), fit: BoxFit.fill)),
      child: Stack(
        children: <Widget>[
          Center(
            child: Padding(
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(
                0, ScreenUtil().setHeight(20), ScreenUtil().setHeight(40), 0),
            child: Row(
              ...
              children: <Widget>[
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Image.asset(
                      isDonated ? 'images/owl.png' : 'images/owlDe.png',
                    ),
                  ),
                ),
                SizedBox(
                ...
                GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    height: ScreenUtil().setHeight(50),
                    child: Image.asset(
                      isCaught ? 'images/shovel.png' : 'images/shovelDe.png',
                    ),
                  ),
                ),
              ],
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      GestureDetector(
                          onTap: () => onOwlPress(),
                          child: CustomText(
                            text: isDonated ? 'Donated' : 'Not Donated',
                            size: ScreenUtil().setSp(32),
                          ))
                    ],
                  ),
                      ...
                      child: SizedBox(
                        ...
                        child: TextField(
                          ...
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 20,
                              height: ScreenUtil().setHeight(3.2)),
                          controller: name,
                          decoration: InputDecoration(
                            ...
                            enabledBorder: OutlineInputBorder(
                                ...
                                borderSide: BorderSide(
                                    width: 0, color: Color(0xff75CBB5))),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (!isDonatedSelected) {
                          subscription = collectionReference
                              .where('donated', arrayContains: email)
                              .where('type', isEqualTo: 'fossil')
                              .orderBy('name')
                              .snapshots()
                              .listen((datasnapshot) {
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (!isCaughtSelected) {
                          subscription = collectionReference
                              .where('caught', arrayContains: email)
                              .where('type', isEqualTo: 'fossil')
                              .orderBy('name')
                              .snapshots()
                              .listen((datasnapshot) {
                ...
                child: fishlist != null
                    ? GridView.builder(
                        ...
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            ...
                            crossAxisSpacing: 8,
                            mainAxisSpacing: 8),
                        itemCount: isFocused == false
                            ? fishlist.length
                            : newNameList.length,
                        padding: const EdgeInsets.all(10.0),
                        itemBuilder: (context, i) {
                          String url = isFocused == false
                              ? fishlist[i].data['image']
                              : newImageList[i];
                          String newPrice = isFocused == false
                              ? fishlist[i].data['price']
                              : newPriceList[i];
                          String newName = isFocused == false
                              ? fishlist[i].data['name']
                              : newNameList[i];
                          List donated = isFocused == false
                              ? fishlist[i].data['donated']
                              : donatedList[i];
                          List caught = isFocused == false
                              ? fishlist[i].data['caught']
                              : caughtList[i];
                          List<String> newDonatedforBanner =
                              List<String>.from(donated);
                          List<String> newCaughtforBanner =
                              List<String>.from(caught);
